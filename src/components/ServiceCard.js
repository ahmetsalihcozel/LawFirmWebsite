    ...
    render() {
        return <>
            ...
            <Modal show={this.state.show} onHide={this.handleClose}>
                <Modal.Header style={{backgroundColor:"#e2b24c", color:"white"}} closeButton>
                ...
                <Modal.Footer>
                    <Button className="modalButton" style={{backgroundColor:"#e2b24c", border:"none"}} variant="secondary" onClick={this.handleClose}>
                        Kapat
                    </Button>
                </Modal.Footer>
            </Modal>
